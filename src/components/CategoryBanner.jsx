...
const CategoryBanner = () => {
  ...
  return (
    <section className="relative bg-gray-150 py-0 px-[48px]">
      <div
          ...
          <div className="flex gap-6 w-max">
            {categories.map((cat, index) => (
              <Link
                ...
                key={cat.slug}
                className="relative w-[378.66px] h-[378.66px] rounded-lg overflow-hidden flex-shrink-0 shadow"
              ...
              >
                ...
                />
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/30 text-white rounded-lg">
                  <p className="text-[36px] font-bold tracking-wide drop-shadow">
                    {cat.name}
                  </p>
                  <div
                    className={`mt-4 w-10 h-10 md:w-12 md:h-12 rounded-full bg-white text-gray-700 flex items-center justify-center shadow-md transition-all duration-300 transform ${
                        hoveredIndex === index
