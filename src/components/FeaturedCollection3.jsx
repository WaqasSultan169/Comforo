...
export default function FeaturedCollection3() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await axios.get(`${BASE_URL}/api/products?category=lingerie`);
    ...
    <section className="bg-gray-150 py-16">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-[40px] font-bold">  </h2>
          <Link
            to="/collections/Lingerie"
