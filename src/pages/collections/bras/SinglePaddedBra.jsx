...
const SinglePaddedBra = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await axios.get(`${BASE_URL}/api/products?category=bras&subcategory=single-padded-bra`);
        setProducts(res.data);
      } catch (error) {
        console.error("Failed to fetch Single Padded bra products", error);
      }
    };
...
export default SinglePaddedBra;
