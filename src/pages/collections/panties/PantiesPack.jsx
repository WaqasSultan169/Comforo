...
const PantiesPack = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await axios.get(`${BASE_URL}/api/products?category=panties&subcategory=panties-pack`);
        setProducts(res.data);
      } catch (error) {
        console.error("Failed to fetch Panties Pack products", error);
      }
    };
